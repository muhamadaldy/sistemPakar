    ...
    <main class="app-main">
        <div class="app-content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0">Tambah Penyakit & Aturan Baru</h3>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Formulir Penyakit Baru</h3>
                            </div>
                                ...
                                @csrf<div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="gambar" class="form-label">Upload Gambar Penyakit</label>
                ...
                <div class="modal-body">
                    <form id="formTambahGejala">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="gejala_bagian" name="bagian" required>
...
@push('modals')
    <div class="modal fade" id="modalTambahSolusi" tabindex="-1" role="dialog" aria-modal="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
