                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box text-bg-danger">
                            ...
                            <a href="{{ route('admin.penyakit.index') }}"
                                class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                                Lihat Data Penyakit <i class="bi bi-arrow-right-circle"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box text-bg-success">
                            ...
                            <i class="bi bi-diagram-3-fill small-box-icon"
                                style="font-size: 4rem; position: absolute; right: 10px; top: 10px; opacity: 0.4;"></i>

                            <a href="{{ route('admin.aturan.index') }}"
                                class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                                Kelola Aturan <i class="bi bi-arrow-right-circle"></i>
                            </a>
                        </div>
                    </div>
                </div>
